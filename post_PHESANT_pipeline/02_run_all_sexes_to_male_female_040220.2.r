...
fwrite(cts_output[,to_keep_all_sexes_cts], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_irnt.tsv", sep='\t')
fwrite(cts_output_males[, to_keep_males_cts], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_irnt_males.tsv" , sep='\t')
fwrite(cts_output_females[, to_keep_females_cts], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_irnt_females.tsv" , sep='\t')
...
fwrite(cts_output_raw[,to_keep_all_sexes_cts_raw], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_raw.tsv", sep='\t')
fwrite(cts_output_males_raw[, to_keep_males_cts_raw], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_raw_males.tsv" , sep='\t')
fwrite(cts_output_females_raw[, to_keep_females_cts_raw], file="/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cts_raw_females.tsv" , sep='\t')
...
for(i in 1:4)
{
	...
	fwrite(cbind(all_sexes$userId, prep_for_cbind(cat_ordered_all_sexes,to_keep_all_sexes_ordered), prep_for_cbind(cat_unordered_all_sexes,to_keep_all_sexes)), 
		sep='\t', file=paste0('/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cat_variables_both_sexes.', i, '.tsv'))
	fwrite(cbind(PHESANT_males$userId, prep_for_cbind(cat_ordered_males,to_keep_males_ordered), prep_for_cbind(cat_unordered_males,to_keep_male)), 
		sep='\t', file=paste0('/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cat_variables_males.', i, '.tsv'))
	fwrite(cbind(PHESANT_females$userId, prep_for_cbind(cat_ordered_females,to_keep_females_ordered), prep_for_cbind(cat_unordered_females,to_keep_female)), 
		sep='\t', file=paste0('/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/ukb41102.nealesamps.nowithdraw.phesant_head.noempty_cat_variables_females.', i, '.tsv'))
