...
root_file <- "/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/ukb34322.nealesamps.nowithdraw.phesant_head.nodisease"
...
fwrite(pheno_summary, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_both_sexes_no_sex_specific_summary.tsv', quote=FALSE, sep='\t', row.names=TRUE)
fwrite(pheno, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_both_sexes_no_sex_specific.tsv', quote=FALSE, sep='\t')
...
fwrite(pheno_summary, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_males_summary.tsv', quote=FALSE, sep='\t', row.names=TRUE)
fwrite(pheno, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_males.tsv', quote=FALSE, sep='\t')
...
fwrite(pheno_summary, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_females_summary.tsv', quote=FALSE, sep='\t', row.names=TRUE)
fwrite(pheno, file='/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/phesant_output_combined_females.tsv', quote=FALSE, sep='\t')
