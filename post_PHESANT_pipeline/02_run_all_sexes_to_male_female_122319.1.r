...
root_file_males <- "/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/output.males"
root_file_females <- "/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/output.females"
