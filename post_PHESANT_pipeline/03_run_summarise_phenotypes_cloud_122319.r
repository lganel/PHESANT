...
out_root_file <- "/gscmnt/gc2802/halllab/lganel/ukbb/mt_cn/phesant/ukb34322.nealesamps.nowithdraw.phesant_head.nodisease"
...
system(paste0("/usr/bin/awk 'FNR==1 && NR!=1 { while (/^<header>/) getline; } 1 {print}' ", root_file, ".*.log > ", root_file, "_all.log"))
